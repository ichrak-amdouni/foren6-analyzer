...
void dodag_update_from_dodag_config(di_dodag_t *dodag, const rpl_dodag_config_t *dodag_config) {
    if ( dodag_config ) {
...
void dodag_update_from_dodag_prefix_info(di_dodag_t *dodag, const rpl_prefix_t *prefix) {
    if ( prefix ) {
