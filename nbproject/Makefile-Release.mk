...
${OBJECTDIR}/_ext/1968008247/circular_buffer.o: /home/am/NetBeansProjects/packet_parser/circular_buffer.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1968008247/circular_buffer.o /home/am/NetBeansProjects/packet_parser/circular_buffer.c

${OBJECTDIR}/_ext/1968008247/descriptor_poll.o: /home/am/NetBeansProjects/packet_parser/descriptor_poll.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1968008247
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1968008247/descriptor_poll.o /home/am/NetBeansProjects/packet_parser/descriptor_poll.c
...
${OBJECTDIR}/_ext/730068611/rpl_parser.o: /home/am/NetBeansProjects/packet_parser/packet_parsers/rpl_parser.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/730068611/rpl_parser.o /home/am/NetBeansProjects/packet_parser/packet_parsers/rpl_parser.c

${OBJECTDIR}/_ext/1968008247/property.o: /home/am/NetBeansProjects/packet_parser/property.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1968008247
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1968008247/property.o /home/am/NetBeansProjects/packet_parser/property.c

${OBJECTDIR}/data_collector/rpl_collector.o: data_collector/rpl_collector.c 
	${MKDIR} -p ${OBJECTDIR}/data_collector
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/data_collector/rpl_collector.o data_collector/rpl_collector.c

${OBJECTDIR}/data_collector/rpl_event_callbacks.o: data_collector/rpl_event_callbacks.c 
	${MKDIR} -p ${OBJECTDIR}/data_collector
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/data_collector/rpl_event_callbacks.o data_collector/rpl_event_callbacks.c

${OBJECTDIR}/data_info/address.o: data_info/address.c 
	${MKDIR} -p ${OBJECTDIR}/data_info
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/data_info/address.o data_info/address.c

${OBJECTDIR}/data_info/dodag.o: data_info/dodag.c 
	${MKDIR} -p ${OBJECTDIR}/data_info
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/data_info/dodag.o data_info/dodag.c

${OBJECTDIR}/data_info/link.o: data_info/link.c 
	${MKDIR} -p ${OBJECTDIR}/data_info
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/data_info/link.o data_info/link.c

${OBJECTDIR}/data_info/metric.o: data_info/metric.c 
	${MKDIR} -p ${OBJECTDIR}/data_info
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/data_info/metric.o data_info/metric.c

${OBJECTDIR}/data_info/node.o: data_info/node.c 
	${MKDIR} -p ${OBJECTDIR}/data_info
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/data_info/node.o data_info/node.c

${OBJECTDIR}/data_info/route.o: data_info/route.c 
	${MKDIR} -p ${OBJECTDIR}/data_info
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/data_info/route.o data_info/route.c

${OBJECTDIR}/data_info/rpl_instance.o: data_info/rpl_instance.c 
	${MKDIR} -p ${OBJECTDIR}/data_info
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/data_info/rpl_instance.o data_info/rpl_instance.c

${OBJECTDIR}/interface_readers/interface_telos.o: interface_readers/interface_telos.c 
	${MKDIR} -p ${OBJECTDIR}/interface_readers
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/interface_readers/interface_telos.o interface_readers/interface_telos.c

${OBJECTDIR}/interface_readers/interfaces_register.o: interface_readers/interfaces_register.c 
	${MKDIR} -p ${OBJECTDIR}/interface_readers
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/interface_readers/interfaces_register.o interface_readers/interfaces_register.c

${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.c

${OBJECTDIR}/packet_parsers/parser_register.o: packet_parsers/parser_register.c 
	${MKDIR} -p ${OBJECTDIR}/packet_parsers
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/packet_parsers/parser_register.o packet_parsers/parser_register.c

${OBJECTDIR}/rpl_packet_parser.o: rpl_packet_parser.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/rpl_packet_parser.o rpl_packet_parser.c

${OBJECTDIR}/sniffer_packet_parser.o: sniffer_packet_parser.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/sniffer_packet_parser.o sniffer_packet_parser.c
